...
function listCheckoutCoupons(items = []) {
  return callCloudFunction('orderApi', 'listCheckoutCoupons', { items })
}

function refreshLogistics(id, force = false) {
  return callCloudFunction('orderApi', 'refreshLogistics', { id, force: Boolean(force) })
}
