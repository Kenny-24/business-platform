...
async function listCoupons(status = 'all') {
  return callCloudFunction('userApi', 'listCoupons', { status })
}


async function listClaimableCoupons() {
  return callCloudFunction('userApi', 'listClaimableCoupons')
}

async function claimCoupon(couponId) {
  return callCloudFunction('userApi', 'claimCoupon', { couponId })
}
