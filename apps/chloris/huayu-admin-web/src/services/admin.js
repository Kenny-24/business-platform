...
export const adminApi = {
  ...
  listCoupons() {
    return callAdmin('listCoupons')
  },

  seedCoupons() {
    return callAdmin('seedCoupons')
  },

  saveCoupon(coupon) {
    return callAdmin('saveCoupon', { coupon })
  },

  deleteCoupon(id) {
    return callAdmin('deleteCoupon', { id })
  },

  issueCoupon(id, payload = {}) {
    return callAdmin('issueCoupon', { id, ...payload })
  },
