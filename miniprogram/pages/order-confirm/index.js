...
Page({
  ...
  async initialize() {
    ...
    this.setData({
      draft,
      deliveryMethodId: draft.deliveryMethodId || 'delivery',
    ...
    try {
      ...
      this.setData({
        ...
        deliverySlot: options.deliverySlots && options.deliverySlots[0] || '',
        deliverySlotIndex: 0,
        loading: false
      })
  ...
  chooseDeliveryMethod() {
    const items = this.data.options.deliveryMethods || []
    ...
    wx.showActionSheet({
      ...
      success: (result) => {
        ...
        this.setData({ deliveryMethodId: selected.id })
        this.refreshPreview()
      }
    })
  },
